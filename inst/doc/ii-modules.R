...
## ----sim-event-diagram, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE----
require(igraph) # for %>%
require(SpaDES)
parameters <- list(.globals=list(stackName="landscape", burnStats="nPixelsBurned"),
                   .progress=list(NA),
