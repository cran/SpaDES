...
## ----legendRange, eval=TRUE, echo=TRUE, fig.height=2, dpi=900------------
Plot(mySim$DEM, legendRange=c(0,500), new=TRUE)

## ----zoomExtent, eval=TRUE, echo=TRUE, fig.height=2, dpi=900-------------
Plot(mySim$DEM, zoomExtent=extent(c(-1, 10, -1, 20)), new=TRUE)

## ----arrows, eval=TRUE, echo=TRUE, fig.height=2, dpi=900-----------------
Plot(mySim$DEM, new=TRUE)
